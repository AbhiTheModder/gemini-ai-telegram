...
- **Simple Bots:**
  ...
  - FURTHER If you want to host through any cloud service provider like koyeb,back4app,heroku etc you can use files from [cloud-host](https://github.com/AbhiTheModder/gemini-ai-telegram/tree/cloud-hosting) branch
